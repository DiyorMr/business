            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div className="space-y-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-orange-600 font-semibold leading-tight text-sm sm:text-base">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <h4 className="font-semibold pt-3">О нас</h4>
                    <ul className="space-y-1">
                        <li>О компании</li>
                        <li>Портфолио</li>
                        <li>Блог</li>
                ...
                <div className="space-y-2 text-sm">
                    <h4 className="font-semibold">Программное обеспечение</h4>
                    <ul className="space-y-1">
                        <li>iiko</li>
                        <li>Saby Retail</li>
                    </ul>
                    <h4 className="font-semibold pt-3">Регионы</h4>
                    <ul className="space-y-1">
                        <li>Сочи</li>
                        <li>Краснодар</li>
                        <li>Ростов</li>
                    ...
                    <a href="#" className="text-gray-500 text-xs underline">Все регионы</a>
                </div>
                <div className="space-y-2 text-sm">
                    <h4 className="font-semibold">Социальные сети</h4>
                    <div className="flex gap-3 mt-2 flex-wrap">
                        <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 text-gray-600">
                            <img src="./img/w.svg" alt="VK" className="w-4 h-4" />
                        </a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 text-gray-600">
                            <img src="./img/t.svg" alt="Telegram" className="w-4 h-4" />
                        </a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 text-gray-600">
                            <img src="./img/ok.svg" alt="OK" className="w-4 h-4" />
                        </a>
                        <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-200 text-gray-600">
                            <img src="./img/you.svg" alt="YouTube" className="w-4 h-4" />
                        </a>
                    </div>
                </div>
                <div className="space-y-2 text-sm">
                    ...
                    <h4 className="font-semibold pt-3">Контакты</h4>
                    <ul className="space-y-1">
