...
const Hero = () => {
    ...
    const img = [
        { src: "/img/img1.svg", text: "Кафе, бары, рестораны" },
        { src: "/img/img2.svg", text: "Продуктовые магазины и магазины розничной торговли" },
        { src: "/img/img3.svg", text: "Фастфуд, бистро, рестораны быстрого питания" },
        { src: "/img/img4.svg", text: "Сфера услуг: салоны красоты, фитнес-клубы, медицинские центры" },
    ];
                ...
                <div className="max-w-[1300px] mx-auto px-4">
                    <div className="flex flex-wrap items-center justify-between py-6 gap-4">
                        <div className="flex items-center gap-3">
                            <a href="#">
                                <img src="/img/logo.svg" alt="Logo" className="w-24 sm:w-28 md:w-32" />
                            </a>
                            <h1 className="text-[#F28E35] text-xs sm:text-sm md:text-base font-normal max-w-[160px]">
                                Автоматизация бизнеса под ключ
                            </h1>
                        </div>
                        <div className="flex items-center gap-4 sm:gap-6 flex-wrap justify-end w-full md:w-auto">
                            ...
                            <div className="flex items-center gap-2">
                                <a href="https://t.me/mvdiyor" target="_blank" rel="noopener noreferrer">
                                    <img src="/img/telegramm.svg" alt="@mvdiyor" className="w-6 h-6" />
                                </a>
                                <a href="https://whatsapp/mvdiyor" target="_blank" rel="noopener noreferrer">
                                ...
                                <div className="flex items-center gap-2 border border-white rounded-md px-2 py-1 sm:py-2">
                                    ...
                                    <span className="text-white text-xs sm:text-sm">+7 (958) 111 02-87</span>
                                </div>
                            </div>
                    ...
                    <div className="text-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-4">
                        ...
                        <ul className="flex flex-wrap items-center gap-4 sm:gap-6 justify-center text-sm sm:text-base">
                    ...
                    <div className="py-16 flex flex-col md:flex-row items-center justify-between gap-10">
                        <div className="text-white max-w-xl text-center md:text-left">
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 leading-snug">
                                <span className="text-[#F28E35]">АВТОМАТИЗАЦИЯ</span> БИЗНЕСА ПОД КЛЮЧ В СОЧИ
                            </h2>
                            <p className="mb-6 text-base sm:text-lg">Увеличим прибыль и сократим расходы за 14 дней!</p>
                            <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base text-gray-200">
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <button className="bg-white text-black font-semibold py-3 px-6 rounded-lg w-full sm:w-auto">
                                    ПОЛУЧИТЬ КОНСУЛЬТАЦИЮ
                                </button>
                                <button className="bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg w-full sm:w-auto">
                                    БЕСПЛАТНЫЙ РАСЧЕТ
                                </button>
                            </div>
                        </div>
                        <div className="relative flex justify-center">
                            <img src="/img/mask.svg" alt="POS machine" className="max-w-[200px] sm:max-w-xs md:max-w-md w-full h-auto" />
                            <p className="absolute top-2 left-6 sm:left-20 text-white bg-red-600 rounded-2xl px-4 py-1 shadow-red-700 shadow-md text-sm sm:text-base">
                                от 00 000 ₽
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-gray-900 py-10">
                    {data.map((block, index) => (
                        <div key={index} className="flex flex-col gap-4">
                            ...
                            <h3 className="text-base sm:text-lg text-orange-500 font-bold">{block.title}</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-gray-900 py-10">
                    {img.map((item, index) => (
                        <div key={index} className="flex flex-col items-center text-center">
                            <img className="w-full max-w-[220px] sm:max-w-[250px] md:max-w-[280px] h-auto object-contain" src={item.src} alt="img" />
                            <p className="text-sm sm:text-base text-gray-700 pt-4">{item.text}</p>
                        </div>
                    ))}
                </div>
            </div>
